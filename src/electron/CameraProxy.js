...
function takePicture(success, error, opts) {
    ...
    //console.log(opts);
    var cameraWindow = cordova.InAppBrowser.open('plugins/cordova-plugin-camera/www/electron/index.html', 'cameraWindow', 'fullscreen=yes, zoom=no');
    ...
    var obs = new MutationObserver(() => {
        var iframe = document.querySelector('iframe[src*="plugins/cordova-plugin-camera/www/electron/index.html"]');
        if (!iframe) return;
